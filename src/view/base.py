...
class BaseView:
    ...
    def get_selected_event(self) -> Dict[str, Any]:
        """Возвращает словарь с выбранным ивентом"""
        return dict(
    ...
    def append_events(self, event: Dict[str, Any]) -> None:
        """функция добавления событий в список"""

        self._event.is_intersection_added_events_list(
            st.session_state.events,
            **event,
        )
        self._event._check_added_event(**event)
